...
/**
 * 类名称：	HswRuntimeException  
 * 类描述：	自定义运行时异常
 * 创建人：  	姜宝俊
 * 创建时间：	2017年7月22日 下午4:19:19  
 * 修改人：
 * 修改时间：
 * @version 1.0.0
 */
public class HswRuntimeException extends RuntimeException  {
	 ...
	 * @param cause
	 */
	public HswRuntimeException(String errorName, String message, Throwable cause) {
		...
		else if (cause instanceof HswRuntimeException) {
			this.errName = ((HswRuntimeException) cause).getErrName();
			this.errCode = ((HswRuntimeException) cause).getErrCode();
			this.errDesc = ((HswRuntimeException) cause).getErrDesc();
		} else {
	 ...
	 * @param cause
	 */
	public HswRuntimeException(String errorName, Throwable cause) {
		// 调用父类的初始化函数，初始化cause
		super(cause);
	 ...
	 * @param message
	 */
	public HswRuntimeException(String errorName, String message) {
		// 调用父类的初始化函数
		super(message);
	 ...
	 * @param errorName
	 */
	public HswRuntimeException(String errorName) {
		// 调用父类的初始化函数
		super();
